...
// cinemaForm: CreateCinemaDto | UpdateCinemaDto = {
//   name: '',
//   address: '',
//   phoneNumber: '',
//   city: '',
...
// submitForm(): void {
//   if (!this.cinemaForm.name || !this.cinemaForm.address || !this.cinemaForm.phoneNumber || !this.cinemaForm.city || !this.cinemaForm.country) {
//     this.alertService.showAlert('Veuillez remplir tous les champs obligatoires.', 'warning');
//     return;
//   }
...
//   if (this.mode === 'create') {
//     // Mode création : appeler la méthode createCinema
//     this.cinemaService.createCinema(this.cinemaForm as CreateCinemaDto).subscribe(
//       (response) => {
...
//   } else if (this.mode === 'edit') {
//     // Mode édition : appeler la méthode updateCinema
//     this.cinemaService.updateCinema(this.cinemaForm as UpdateCinemaDto).subscribe(
//       (response) => {
//         this.handleSuccessResponse(response);
//       },
//       (error) => {
